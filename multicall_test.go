...
func TestABI(t *testing.T) {
	...
	contract := common.HexToAddress("0xf25BCCF3A5125cF5f2d5b393cfB08901556f7a42")
	invokes := []Invoke{
		{
			Contract: contract,
			Name:     "symbol",
	...
	result := []interface{}{"", "", uint8(0)}
	_, err = Do(context.Background(), client, &tokenAB, invokes, result)
	if err != nil {
		t.Fatal(err)
	}
